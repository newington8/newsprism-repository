...
아래 형식에 따라 한국어로 요약하되, 다음 규칙을 반드시 준수하세요:

[★ 필수 규칙 ★]
1. 매출·순이익·EPS·마진·성장률·베이시스포인트 등 모든 수치/통계/데이터는 원문 숫자 그대로 표기 (절대 한글로 풀어쓰지 말 것)
2. 경영진의 중요 발언은 반드시 영어 원문 문장을 먼저 인용 후 한국어 번역 병기
   형식: > "원문 영어 문장" → 한국어 번역
3. 한국어 요약이 주이나, 수치와 핵심 인용문은 영어 원문 우선
...
2. **경영진 핵심 발언** (CEO/CFO 중요 발언 3~5가지)
   > "영어 원문 인용" → 한국어 번역

3. **가이던스** (다음 분기/연간 전망, 수치 원문 그대로)

4. **주요 리스크** (경영진이 언급한 위험 요소)
   > 중요 리스크 발언은 영어 원문 인용 포함
